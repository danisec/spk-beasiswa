        ...
        <div class="grid grid-cols-2">
            <div class="mx-auto flex flex-col gap-6">
                <div class="rounded-t-lg bg-slate-200 px-10 py-4">
                    <h2 class="text-center text-2xl font-bold text-gray-800">Input Data Kriteria
                    </h2>
                </div>

                <form class="flex flex-col gap-6" action="{{ route('kriteria.store') }}" method="post">
                    @csrf
                    ...
                    <div>
                        <input class="@error('nama_kriteria') border-red-300 bg-red-300 @enderror field-input"
                            name="nama_kriteria" type="text" value="{{ old('nama_kriteria') }}"
                    ...
                    <div>
                        <input class="@error('syarat') border-red-300 bg-red-300 @enderror field-input" name="syarat"
                            type="text" value="{{ old('syarat') }}" placeholder="Persyaratan" required>
