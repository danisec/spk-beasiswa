    ...
    <section class="layout min-h-screen w-full py-8">
        ...
        <div class="mx-auto w-6/12">
            <div class="rounded-t-lg bg-slate-200 py-4">
                <h2 class="text-center text-2xl font-bold text-gray-800">Tambah Data Crips
                </h2>
            </div>

            <form class="mt-6 flex flex-col gap-6" action="{{ route('crips.store') }}" method="post">
                @csrf
                ...
                <div>
                    <input class="@error('nama_crips') border-red-300 bg-red-300 @enderror field-input w-full"
                        name="nama_crips" type="text" value="{{ old('nama_crips') }}" placeholder="Nama Crips"
                        required>
                ...
                <div>
                    <input class="@error('bobot') border-red-300 bg-red-300 @enderror field-input w-full" name="bobot"
                        type="text" value="{{ old('bobot') }}" placeholder="Bobot Crips" required>
